...
<head>
    ...
    <title>Login - Ruang Budaya</title>
    ...
    <section class="login-section">
        <div class="banner">
            ...
            <div class="banner-text">
                ...
                <p>Masuk dan Mulailah Eksplore!</p>
            </div>
        </div>
        ...
        <div class="login-box">
            <form method="POST" action="{{ route('login.submit') }}">
                ...
                <button type="submit" class="w-100 mt-2">Login</button>
            </form>
            <p class="text-center mt-3">Belum punya akun? <a href="{{ route('signup') }}" class="text-decoration-none fw-bold text-dark">Register</a></p>
        </div>
